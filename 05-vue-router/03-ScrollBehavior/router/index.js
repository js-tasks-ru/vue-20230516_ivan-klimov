...
export const router = createRouter({
  ...
  scrollBehavior(to, from, savedPosition) {
    ...
    if (to.meta.saveScrollPosition && !from.meta.saveScrollPosition
      || !to.meta.saveScrollPosition && from.meta.saveScrollPosition) return { top: 0, left: 0 };
    if (to.meta.saveScrollPosition && from.meta.saveScrollPosition  || savedPosition) return savedPosition;
